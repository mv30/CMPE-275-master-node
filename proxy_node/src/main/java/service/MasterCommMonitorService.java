...
public class MasterCommMonitorService {
    ...
    public MasterCommMonitorService( Integer hostServerId) {
        ...
        this.peers.put( 1, new IpDetailsEntry("ec2-18-188-86-164.us-east-2.compute.amazonaws.com", 6091, "../replicated-data/replication-1/data.json", "../replicated-data/replication-1/servers.json"));
        this.peers.put( 2, new IpDetailsEntry("ec2-3-134-91-96.us-east-2.compute.amazonaws.com", 6092, "../replicated-data/replication-2/data.json", "../replicated-data/replication-2/servers.json"));
        this.peers.put( 3, new IpDetailsEntry("ec2-18-222-144-176.us-east-2.compute.amazonaws.com", 6093, "../replicated-data/replication-3/data.json", "../replicated-data/replication-3/servers.json"));
    }
